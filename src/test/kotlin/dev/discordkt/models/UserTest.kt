...
import dev.discordkt.models.user.PremiumType
import dev.discordkt.models.user.User
import dev.discordkt.models.user.UserFlag
        ...
        """
{
  ...
  "public_flags": 64
        ...
        """.deserializes<User> {
            ...
            it.flags should containExactly(UserFlag.HOUSE_BRAVERY)
            it.publicFlags should containExactly(UserFlag.HOUSE_BRAVERY)
            it.premiumType shouldBe PremiumType.NITRO_CLASSIC
